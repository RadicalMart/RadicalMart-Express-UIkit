...
?>
<div id="RadicalMartExpress" class="done uk-text-center">
	<div class="uk-text-center uk-container uk-container-small">
		...
		<h1 class="uk-h2 uk-margin-small-top">
			<?php echo $this->params->get('seo_done_h1', Text::_('COM_RADICALMART_EXPRESS_DONE_PAGE_H1')); ?>
		</h1>
		<div>
			<a href="<?php echo Uri::root(); ?>" class="uk-button uk-button-default">
				<?php echo Text::_('COM_RADICALMART_EXPRESS_DONE_PAGE_TO_HOME'); ?>
			</a>
			<a href="<?php echo $this->order->link; ?>" class="uk-button uk-button-default">
				<?php echo Text::_('COM_RADICALMART_EXPRESS_DONE_PAGE_TO_ODER'); ?>
			</a>
			<?php if ($this->order->pay): ?>
				<a href="<?php echo $this->order->pay; ?>" class="uk-button uk-button-primary">
					<?php echo Text::_('COM_RADICALMART_EXPRESS_DONE_PAGE_TO_PAY'); ?>
				</a>
			<?php endif; ?>
		</div>
	</div>
