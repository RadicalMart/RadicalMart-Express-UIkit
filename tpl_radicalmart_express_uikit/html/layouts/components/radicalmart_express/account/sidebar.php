...
use Joomla\Component\RadicalMartExpress\Administrator\Helper\UserHelper;
	...
	<div class="uk-card-header uk-padding-small">
		...
		<div class="uk-margin-top uk-text-center">
			...
			<div class="uk-margin-small">
				<?php echo Text::_('COM_RADICALMART_EXPRESS_JOINED') . ' '
					. HTMLHelper::date($user->registerDate, Text::_('DATE_FORMAT_LC4')); ?>
			</div>
			<div>
				<a href="<?php echo $menus['com_radicalmart_express.settings']['link']; ?>"
				   class="uk-button uk-button-default uk-button-small">
					<span class="" uk-icon="icon: cog; ratio: .75;"></span>
					<?php echo '  ' . Text::_($menus['com_radicalmart_express.settings']['text']); ?>
				</a>
	...
	<div class="uk-card-body">
		<ul class="uk-nav uk-nav-default">
			<?php foreach ($menus as $key => $item):
				if ($key === 'com_radicalmart_express.settings' || $key === 'com_users.logout')
				{
					continue;
				} ?>
